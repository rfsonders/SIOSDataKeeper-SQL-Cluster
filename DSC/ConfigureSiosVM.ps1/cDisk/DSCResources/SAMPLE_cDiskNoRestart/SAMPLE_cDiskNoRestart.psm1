...
function Set-TargetResource
{
    ...
    if(Test-Path $env:windir\Temp\cDiskNoRestart.txt) {
        "Looked again`n" >> $env:windir\Temp\cDiskNoRestart.txt
	return $true
    }
...
function Test-TargetResource
{
	...
	"STOP LOOKING ALREADY`n" > $env:windir\Temp\cDiskNoRestart.txt
        return $true
    }
    return $false
}
